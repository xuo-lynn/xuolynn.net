...
const Status: React.FC = () => {
  ...
  return (
    <div className="relative -ml-3 mt-4">
      {/* Main container */}
      <div className="bg-white rounded-xl px-3 pt-2 pb-1.5 relative w-fit max-w-[min(230px,80vw)]">
        <div className="absolute -top-2.5 left-2.5 w-6 h-4 bg-white rounded-t-full"></div>
        {/* New circle element */}
        <div className="absolute -top-5 -left-2 w-3 h-3 bg-white rounded-full"></div>
        <span className="text-gray-800 text-base break-words block leading-5">
          {customStatus}
        </span>
      </div>
    </div>
