  ...
  return (
    <div className="pt-2 flex flex-col px-4">
      ...
      <div className='text-center text- sm:text-2xl md:text-2xl text-slate-300'>
        ...
        <p className="mb-2">contributing to large-scale, high-impact products. Currently out of</p>
        <p className="mb-2">college and looking for <strong className="text-white">full-time employment!</strong></p>
      </div>
