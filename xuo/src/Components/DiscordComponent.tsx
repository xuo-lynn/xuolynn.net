                    ...
                    <div className="bg-gradient-to-b from-black/70 to-black/20 rounded-lg relative">
                        ...
                        <div className="text-left mt-20 ml-4">
                            <div className="flex items-center">
                                <div>
                                    <h1 className="text-slate-200 text-xl font-semibold pl-2">xuo</h1>
                                    ...
                                    {activeSection === 'about' && (
                                        <div>
                                            <p className="text-slate-300"> 
                                                I'm a junior software engineer with previous engineering experience at <strong style={{ color: '#58bae3' }}>Meta</strong> and <strong style={{ color: 'red' }}>Netflix</strong>. I'll also be joining <strong style={{ color: '#1DB954' }}>Spotify</strong>'s data platform this summer, and planning to start a masters in computer science!
                                            </p>
                                            <br/>
                                            <p className="text-slate-300">
